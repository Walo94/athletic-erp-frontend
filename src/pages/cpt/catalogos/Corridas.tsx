        ...
        <div className="max-w-7xl mx-auto">
          ...
          <CustomCard padding="p-0" className="overflow-hidden">
            {loading ? (
              ...
              <>
              {paginatedCorridas.length === 0 && searchTerm ? (
                ...
                <div className="overflow-auto max-h-[calc(100vh-400px)]">
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-700 sticky top-0 z-10">
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 dark:text-gray-300 uppercase">Corrida</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 dark:text-gray-300 uppercase">Descripción</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 dark:text-gray-300 uppercase">Pto. Inicial</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 dark:text-gray-300 uppercase">Pto. Final</th>
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y dark:divide-gray-700">
                      {paginatedCorridas.map((corrida) => (
                        <tr key={corrida.corrida} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                          <td className="px-6 py-4 text-sm font-medium dark:text-white">{corrida.corrida}</td>
                          <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">{corrida.descripcion}</td>
                          <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">{corrida.puntoInicial}</td>
                          <td className="px-6 py-4 text-sm text-gray-800 dark:text-gray-300">{corrida.puntoFinal}</td>
